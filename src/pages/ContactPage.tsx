  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Address',
      details: ['123 Business District', 'Trade City, TC 12345', 'United States']
    },
    {
      icon: Phone,
      title: 'Phone',
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['info@globaltrade.com', 'sales@globaltrade.com']
    },
    {
      icon: Clock,
      ...
      <section className="relative h-96 bg-gradient-to-r from-blue-900 to-blue-700">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <p className="text-xl font-light">Let's discuss your import-export requirements</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">We're here to help with all your trading needs</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your requirements, preferred products, quantities, and any other details..."
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-blue-800 text-white px-6 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2"
                >
            ...
            >
              ...
              <div className="bg-blue-50 p-6 rounded-xl">
                <h4 className="text-xl font-bold text-gray-900 mb-4">Why Contact Us?</h4>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span>Free consultation on your import-export needs</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span>Custom solutions for your business requirements</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0" />
              ...
              <div className="bg-yellow-50 p-6 rounded-xl border-l-4 border-yellow-500">
                ...
                <p className="text-gray-600 text-sm">
                  We understand that time is crucial in international trade. Our team commits to 
